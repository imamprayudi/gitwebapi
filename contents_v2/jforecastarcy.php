     ...
     <section class="section">
      <div class="row">
        <div class="card card-info">
          <div class="card-body">
            <form name="submit_fcyArcOld" class="row gx-3 gy-2 align-items-center">
              <div class="col-6">
              ...
              <div class="col-2 mt-4">
                <input type=submit value="Display" class="btn btn-info" id="submit_fcyArcOld" name="submit_fcyArcOld">
              </div>
            </form>
      ...
      <div class="row"> <!-- sfcl -->
        <div class="card recent-sales overflow-auto ml-3">
          <div class="card-header">
            FORECAST ARCHIVED OLD
          </div>
          <div class="card-body">
            <table id="table-forecastArcOld" class="table table-striped ml-3 display responsive nowrap"></table>
          </div>
        </div>
      </div>
    </section>
