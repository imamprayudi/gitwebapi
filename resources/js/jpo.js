...
$(function () {
    ...
    console.log('apienpoint', apiEndpoint);
    console.log($); // Memeriksa apakah jQuery sudah ter-load
    console.log($.fn.select2); // Memeriksa apakah fungsi select2 tersedia
